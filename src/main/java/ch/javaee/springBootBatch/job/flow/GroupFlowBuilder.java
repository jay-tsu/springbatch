 ...
 *
 */
public class GroupFlowBuilder<Q> {
    ...
    private GroupFlow flow;

    private boolean dirty = true;

    public GroupFlowBuilder(String name) {
        this.name = name;
        this.prefix = name + ".";
     ...
     */
    public GroupFlowBuilder<Q> next(Step step) {
        doNext(step);
        return this;
    }
     ...
     * @return this to enable chaining
     */
    public GroupFlowBuilder<Q> start(Step step) {
        doStart(step);
        return this;
    }
     ...
     * @return this to enable chaining
     */
    public GroupFlowBuilder<Q> from(Step step) {
        doFrom(step);
        return this;
    }
     ...
     * @return this to enable chaining
     */
    public GroupFlowBuilder.UnterminatedFlowBuilder<Q> next(JobExecutionDecider decider) {
        doNext(decider);
        return new GroupFlowBuilder.UnterminatedFlowBuilder<Q>(this);
    }
     ...
     */
    public GroupFlowBuilder.UnterminatedFlowBuilder<Q> start(JobExecutionDecider decider) {
        doStart(decider);
        return new GroupFlowBuilder.UnterminatedFlowBuilder<Q>(this);
    }
     ...
     * @return a builder to enable chaining
     */
    public GroupFlowBuilder.UnterminatedFlowBuilder<Q> from(JobExecutionDecider decider) {
        doFrom(decider);
        return new GroupFlowBuilder.UnterminatedFlowBuilder<Q>(this);
    }
     ...
     * @return a builder to enable chaining
     */
    public GroupFlowBuilder<Q> next(Flow flow) {
        doNext(flow);
        return this;
    }
     ...
     * @return a builder to enable chaining
     */
    public GroupFlowBuilder<Q> from(Flow flow) {
        doFrom(flow);
        return this;
    }
     ...
     * @return a builder to enable chaining
     */
    public GroupFlowBuilder<Q> start(Flow flow) {
        doStart(flow);
        return this;
    }
     ...
     */
    public GroupFlowBuilder.SplitBuilder<Q> split(TaskExecutor executor) {
        return new GroupFlowBuilder.SplitBuilder<Q>(this, executor);
    }
     ...
     * @return a builder to enable fluent chaining
     */
    public GroupFlowBuilder.TransitionBuilder<Q> on(String pattern) {
        return new GroupFlowBuilder.TransitionBuilder<Q>(this, pattern);
    }
    ...
    private State createState(Object input) {
        ...
        if (input instanceof Step) {
            if (!states.containsKey(input)) {
                ...
                states.put(input, new GroupStepState(prefix + step.getName(), step));
            }
    ...
    public static class UnterminatedFlowBuilder<Q> {
        ...
        private final GroupFlowBuilder<Q> parent;

        public UnterminatedFlowBuilder(GroupFlowBuilder<Q> parent) {
            this.parent = parent;
        }
         ...
         */
        public GroupFlowBuilder.TransitionBuilder<Q> on(String pattern) {
            return new GroupFlowBuilder.TransitionBuilder<Q>(parent, pattern);
        }
    ...
    public static class TransitionBuilder<Q> {
        ...
        public TransitionBuilder(GroupFlowBuilder<Q> parent, String pattern) {
            this.parent = parent;
         ...
         * @return a GroupFlowBuilder
         */
        public GroupFlowBuilder<Q> to(Step step) {
         ...
         * @return a GroupFlowBuilder
         */
        public GroupFlowBuilder<Q> to(Flow flow) {
         ...
         * @return a GroupFlowBuilder
         */
        public GroupFlowBuilder<Q> to(JobExecutionDecider decider) {
         ...
         * @return a GroupFlowBuilder
         */
        public GroupFlowBuilder<Q> stop() {
            parent.stop(pattern);
            return parent;
        }
         ...
         * @return a GroupFlowBuilder
         */
        public GroupFlowBuilder<Q> stopAndRestart(Flow flow) {
            State next = parent.createState(flow);
         ...
         * @return a GroupFlowBuilder
         */
        public GroupFlowBuilder<Q> stopAndRestart(JobExecutionDecider decider) {
            State next = parent.createState(decider);
            parent.stop(pattern, next);
            return parent;
        }
         ...
         * @return a GroupFlowBuilder
         */
        public GroupFlowBuilder<Q> stopAndRestart(Step restart) {
         ...
         * @return a GroupFlowBuilder
         */
        public GroupFlowBuilder<Q> end(String status) {
         ...
         * @return a GroupFlowBuilder
         */
        public GroupFlowBuilder<Q> fail() {
            parent.fail(pattern);
            return parent;
        }
    }
    ...
    /**
     * A builder for building a split state. Example (<code>builder</code> is a {@link GroupFlowBuilder}):
     *
     * <pre>
     ...
     * <pre>
     * // instead of this
     * Flow complexFlow = new GroupFlowBuilder&lt;GroupFlow&gt;("ComplexParallelFlow")
     *                       .start(flow1)
     *                       .next(flow2)
     ...
     *
     * // do this
     * Flow splitFlow = new GroupFlowBuilder&lt;GroupFlow&gt;("parallelFlow")
     *                       .start(flow3)
     *                       .split(new SimpleAsyncTaskExecutor())
     *                       .add(flow4).build();
     *
     * Flow complexFlow = new GroupFlowBuilder&lt;SimpleFlow&gt;("ComplexParallelFlow")
     *                       .start(flow1)
     *                       .next(flow2)
     *                       .next(splitFlow)
     *                       .build();
    ...
    public static class SplitBuilder<Q> {
         ...
         */
        public SplitBuilder(GroupFlowBuilder<Q> parent, TaskExecutor executor) {
            this.parent = parent;
         ...
         */
        public GroupFlowBuilder<Q> add(Flow... flows) {
            ...
            if (!(one == null || one instanceof FlowState)) {
                GroupFlowBuilder<Flow> stateBuilder = new GroupFlowBuilder<Flow>(name + "_" + (counter++));
